...
public enum DBUtilErrorCode implements ErrorCode{
    ...
    COMMIT_ERROR("DBUtilErrorCode-20", "事务提交失败"),
    ROLLBACK_ERROR("DBUtilErrorCode-21", "事务回滚失败"),
    CONN_NULL("DBUtilErrorCode-22", "数据库Connection为空，请检查数据库连接情况"),
    METEDATA_ERROR("DBUtilErrorCode-23", "获取元数据错误");
    ;
